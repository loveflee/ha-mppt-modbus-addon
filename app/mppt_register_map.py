...
# -*- coding: utf-8 -*-
# ------------------------------------------------------------------
# 📌 佛山金廣源 Ampinvt MPPT - 寄存器映射表 (V6.4 鐵鋰安全版)
# ------------------------------------------------------------------
...
# ✅ B1：完整數據
B1_INFO = [
    { "key": "battery_type", "name": "電池類型", "unit": None, "scale": 1, "offset": 8, "length": 1, "signed": False, "map": { 0: "鉛酸(免維護)", 1: "鉛酸(膠體)", 2: "鉛酸(液體)", 3: "鋰電池" }, "ha": {"type": "sensor", "icon": "mdi:car-battery"} },
    { "key": "recognition_mode", "name": "識別方式", "unit": None, "scale": 1, "offset": 9, "length": 1, "signed": False, "map": { 0: "自動識別", 1: "手動設定", 2: "手動(24V)", 3: "手動(36V)", 4: "手動(48V)", 5: "手動(60V)", 6: "手動(72V)", 7: "手動(84V)", 8: "手動(96V)" }, "ha": {"type": "sensor", "icon": "mdi:eye-refresh"} },
    { "key": "battery_count", "name": "電池串數", "unit": "串", "scale": 1, "offset": 10, "length": 1, "signed": False, "ha": {"type": "sensor", "icon": "mdi:battery-plus"} },
    { "key": "load_control_mode", "name": "負載控制模式", "unit": None, "scale": 1, "offset": 11, "length": 1, "signed": False, "map": { 0: "關閉", 1: "自動(光控+時控)", 2: "時間控制", 3: "光控模式", 4: "遠程控制" }, "ha": {"type": "sensor", "icon": "mdi:cog-transfer"} },
    ...
    { "key": "hw_max_charge_current", "name": "硬體最大充電電流", "unit": "A", "scale": 100, "offset": 24, "length": 2, "signed": False, "ha": {"type": "sensor", "device_class": "current", "icon": "mdi:microchip"} },
...
# ✅ D0：可控參數 (V6.4 鐵鋰安全版)
# 鉛酸 base: 9.0 ~ 17.0 V
# 鋰電 base (LiFePO4 4S): 9.0 ~ 14.6 V (嚴格限制)
D0_PARAMS = {
    ...
    # 🟢 均充/浮充：上限 14.6V
    0x21: { "key": "set_equalize_voltage", "name": "設定-均充電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "base_min": 9.0, "base_max": 17.0, "li_base_min": 10.0, "li_base_max": 14.6, "step": 0.1, "mode": "box", "link_b1": "equalize_voltage"} },
            
    0x22: { "key": "set_float_voltage", "name": "設定-浮充電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "base_min": 9.0, "base_max": 17.0, "li_base_min": 10.0, "li_base_max": 14.6, "step": 0.1, "mode": "box", "link_b1": "float_voltage"} },
            
    # 🟢 過放下限：下限 9.0V
    0x23: { "key": "set_discharge_limit", "name": "設定-放電下限電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "base_min": 9.0, "base_max": 17.0, "li_base_min": 9.0, "li_base_max": 14.6, "step": 0.1, "mode": "box", "link_b1": "discharge_limit_voltage"} },
            
    0x25: { "key": "set_max_charge_curr", "name": "設定-最大充電電流", "unit": "A", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "min": 0.0, "max": 60.0, "step": 1.0, "mode": "slider", "link_b1": "max_charge_current"} },
            
    # 🟢 過放恢復
    0x26: { "key": "set_discharge_recover", "name": "設定-過放恢復電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "base_min": 9.0, "base_max": 17.0, "li_base_min": 10.0, "li_base_max": 14.6, "step": 0.1, "mode": "box", "link_b1": "discharge_recovery_voltage"} },
            
    # 🟢 過壓保護：絕對上限 14.6V (鐵鋰安全線)
    0x27: { "key": "set_over_prot_vol", "name": "設定-過壓保護電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "base_min": 9.0, "base_max": 17.0, "li_base_min": 12.0, "li_base_max": 14.6, "step": 0.1, "mode": "box", "link_b1": "over_voltage_protection"} },
            
    # 🟢 過壓恢復：上限 14.6V
    0x28: { "key": "set_over_recover_vol", "name": "設定-過壓恢復電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "base_min": 9.0, "base_max": 17.0, "li_base_min": 12.0, "li_base_max": 14.6, "step": 0.1, "mode": "box", "link_b1": "over_voltage_recovery"} },
            
    # 光控設定維持不變
    0x29: { "key": "set_light_on_vol", "name": "設定-光控開啟電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
            "ha": {"type": "number", "min": 0.0, "max": 50.0, "step": 1.0, "mode": "box", "link_b1": "light_control_on_voltage"} },
    0x2A: { "key": "set_light_off_vol", "name": "設定-光控關閉電壓", "unit": "V", "data_len": 2, "scale": 0.01, "valid_bytes": [5, 6], 
